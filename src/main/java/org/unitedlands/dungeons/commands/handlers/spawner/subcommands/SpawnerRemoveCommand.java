...
public class SpawnerRemoveCommand extends BaseCommandHandler<UnitedDungeons> {

    public SpawnerRemoveCommand(UnitedDungeons plugin, IMessageProvider messageProvider) {
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        ...
        if (args.length != 0) {
            Messenger.sendMessage(sender, messageProvider.get("messages.info-spawner-remove"), null,
