...
public class LockChestInfoCommand extends BaseCommandHandler<UnitedDungeons> {

    public LockChestInfoCommand(UnitedDungeons plugin, IMessageProvider messageProvider) {
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        ...
        Messenger.sendMessage(player, FieldHelper.getFieldValuesString(LockChest.class, chest));
    }
