...
public class SpawnerRemoveCommand extends BaseCommandHandler {

    public SpawnerRemoveCommand(UnitedDungeons plugin) {
        super(plugin);
    }
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        ...
        if (args.length != 0) {
            Messenger.sendMessageTemplate(sender, "info-spawner-remove", null, true);
            return;
        }
