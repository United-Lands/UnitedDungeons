...
// public class DungeonCommandsOld implements CommandExecutor {

//     private final UnitedDungeons plugin;

//     public DungeonCommandsOld(UnitedDungeons plugin) {
//         this.plugin = plugin;
//     }
...
//         dungeon = new Dungeon(plugin, player.getLocation());
