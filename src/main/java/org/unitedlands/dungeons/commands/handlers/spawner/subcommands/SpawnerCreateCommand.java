package org.unitedlands.dungeons.commands.handlers.spawner.subcommands;
...
public class SpawnerCreateCommand extends BaseCommandHandler<UnitedDungeons> {

    public SpawnerCreateCommand(UnitedDungeons plugin, IMessageProvider messageProvider) {
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        if (args.length != 0) {
            Messenger.sendMessage(sender, messageProvider.get("messages.info-spawner-create"), null,
        ...
        Spawner spawner = new Spawner(player.getLocation());
